...
public:
  ...
  NS_IMETHODIMP GetUserAgent(JSContext *cx, nsAString &aUserAgent);
  NS_IMETHODIMP GetProduct(JSContext *cx, nsAString &aProduct);
  NS_IMETHODIMP GetProductSub(JSContext *cx, nsAString &aProductSub);
  NS_IMETHODIMP GetAppCodeName(JSContext *cx, nsAString &aAppCodeName);
  NS_IMETHODIMP GetAppVersion(JSContext *cx, nsAString &aAppVersion);
  NS_IMETHODIMP GetLanguage(JSContext *cx, nsAString &aLanguage);
  NS_IMETHODIMP GetVendor(JSContext *cx, nsAString &aVendor);
  NS_IMETHODIMP GetVendorSub(JSContext *cx, nsAString &aVendorSub);
  bool OnLine(JSContext *cx);
  bool CookieEnabled(JSContext *cx);
  bool JavaEnabled(JSContext *cx, ErrorResult& aRv);
