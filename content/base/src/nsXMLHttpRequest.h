...
private:
  ...
  nsresult Send(nsIVariant* aVariant, const Nullable<RequestBody>& aBody){
	  return Send((JSContext *)NULL, aVariant, aBody);
  }
  nsresult Send(JSContext *cx, nsIVariant* aVariant, const Nullable<RequestBody>& aBody);
  
  nsresult Send(const Nullable<RequestBody>& aBody)
  {
    return Send((JSContext *)NULL, nullptr, aBody);
  }
  nsresult Send(JSContext *cx, const Nullable<RequestBody>& aBody)
  {
    return Send(cx, nullptr, aBody);
  }
  
  nsresult Send(const RequestBody& aBody)
  {
    return Send((JSContext *)NULL, Nullable<RequestBody>(aBody));
  }
  nsresult Send(JSContext *cx, const RequestBody& aBody)
  {
    return Send(cx, Nullable<RequestBody>(aBody));
  }
...
public:
  ...
  {
    aRv = Send((JSContext *)NULL, Nullable<RequestBody>());
  }
  void Send(JSContext *cx, ErrorResult& aRv)
  {
    aRv = Send(cx, Nullable<RequestBody>());
  }
  
  void Send(const mozilla::dom::ArrayBuffer& aArrayBuffer, ErrorResult& aRv)
  {
    aRv = Send((JSContext *)NULL, RequestBody(&aArrayBuffer));
  }
  void Send(JSContext *cx, const mozilla::dom::ArrayBuffer& aArrayBuffer, ErrorResult& aRv)
  {
    aRv = Send(cx, RequestBody(&aArrayBuffer));
  }
  
  void Send(const mozilla::dom::ArrayBufferView& aArrayBufferView,
            ErrorResult& aRv)
  {
    aRv = Send((JSContext *)NULL, RequestBody(&aArrayBufferView));
  }
  void Send(JSContext *cx, const mozilla::dom::ArrayBufferView& aArrayBufferView,
            ErrorResult& aRv)
  {
    aRv = Send(cx, RequestBody(&aArrayBufferView));
  }
  
  void Send(nsIDOMBlob* aBlob, ErrorResult& aRv)
  {
    NS_ASSERTION(aBlob, "Null should go to string version");
    aRv = Send((JSContext *)NULL, RequestBody(aBlob));
  }
  void Send(JSContext *cx, nsIDOMBlob* aBlob, ErrorResult& aRv)
  {
    NS_ASSERTION(aBlob, "Null should go to string version");
    aRv = Send(cx, RequestBody(aBlob));
  }
  
  void Send(nsIDocument& aDoc, ErrorResult& aRv)
  {
    aRv = Send((JSContext *)NULL, RequestBody(&aDoc));
  }
  void Send(JSContext *cx, nsIDocument& aDoc, ErrorResult& aRv)
  {
    aRv = Send(cx, RequestBody(&aDoc));
  }
  
  void Send(const nsAString& aString, ErrorResult& aRv)
  {
    if (DOMStringIsNull(aString)) {
      Send((JSContext *)NULL, aRv);
    }
    else {
      aRv = Send((JSContext *)NULL, RequestBody(aString));
    }
  }
  void Send(JSContext *cx, const nsAString& aString, ErrorResult& aRv)
  {
    if (DOMStringIsNull(aString)) {
      Send(cx, aRv);
    }
    else {
      aRv = Send(cx, RequestBody(aString));
    }
  }
  
  void Send(nsFormData& aFormData, ErrorResult& aRv)
  {
    aRv = Send((JSContext *)NULL, RequestBody(aFormData));
  }
  void Send(JSContext *cx, nsFormData& aFormData, ErrorResult& aRv)
  {
    aRv = Send(cx, RequestBody(aFormData));
  }
  
  void Send(nsIInputStream* aStream, ErrorResult& aRv)
  {
    NS_ASSERTION(aStream, "Null should go to string version");
    aRv = Send((JSContext *)NULL, RequestBody(aStream));
  }
  void Send(JSContext *cx, nsIInputStream* aStream, ErrorResult& aRv)
  {
    NS_ASSERTION(aStream, "Null should go to string version");
    aRv = Send(cx, RequestBody(aStream));
  }
