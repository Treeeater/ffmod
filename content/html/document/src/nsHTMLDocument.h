...
public:
  ...
  void GetCookie(JSContext *cx, nsAString& aCookie, mozilla::ErrorResult& rv);
  void SetCookie(const nsAString& aCookie, mozilla::ErrorResult& rv){
	  SetCookie(NULL, aCookie, rv);
  }
  void SetCookie(JSContext *cx, const nsAString& aCookie, mozilla::ErrorResult& rv);
